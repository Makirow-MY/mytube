      ...
      <form onSubmit={handleSubmit} className="flex">
        <div className="relative flex items-center flex-1">
          <input
            ...
            placeholder="Search"
            className="w-full rounded-l-full border text-sm pl-4 py-1.5  pr-12 focus:outline-none focus:border-blue-500"
          />
        ...
        <Button type="submit" variant="outline" className="rounded-r-full  py-3  px-6">
